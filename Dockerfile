...
FROM registry.docker.com/library/ruby:4.0.2-slim@sha256:70b582c9e959be5680a3abbaaad6d7fc4539e1c2ec61610e3125d6138560b3ab AS base
...
RUN set -eux ; \
    gem update --system "4.0.9" ; \
    gem install bundler --version "4.0.9" --force
...
CMD ["sh", "-c", "HTTP_PORT=${PORT:-3000} ./bin/thrust ./bin/rails server"]
