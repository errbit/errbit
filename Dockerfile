...
FROM registry.docker.com/library/ruby:4.0.2-slim@sha256:f7bc36f1cfcbe49ff3a57c9ea05a01eb7badf83d5dd532c4347a3887ca68ba0d AS base
...
RUN set -eux ; \
    ...
    gem install bundler --version "4.0.8" --force
