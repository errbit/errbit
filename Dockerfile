...
FROM registry.docker.com/library/ruby:4.0.5-slim@sha256:577dc71a969f4f7c5a4b1d43b815ecf6523950436a81ae6d84b25c4e87cf37d5 AS base
...
RUN set -eux ; \
    gem update --system "4.0.12" ; \
    gem install bundler --version "4.0.12" --force
