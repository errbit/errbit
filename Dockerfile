...
FROM registry.docker.com/library/ruby:4.0.5-slim@sha256:2726c400123eedf50d49696f27bcb01e90758ebd2a8e3bc73b9f18f75f3b87f5 AS base
...
RUN set -eux ; \
    gem update --system "4.0.15" ; \
    gem install bundler --version "4.0.15" --force
