...
FROM registry.docker.com/library/ruby:3.4.4-slim@sha256:4020c2d289c1266fe4a2ea1d0018c22c17435905c514c66f8437555da57723ad AS base
...
RUN set -eux ; \
    ...
    gem install bundler --version "2.6.9" --force
