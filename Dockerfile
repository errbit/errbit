...
FROM registry.docker.com/library/ruby:4.0.3-slim@sha256:327406df0303d3de9d3f6b196c645511edaee360a46681a310d1c738bb9a2ad2 AS base
...
RUN set -eux ; \
    gem update --system "4.0.11" ; \
    gem install bundler --version "4.0.11" --force
