...
FROM registry.docker.com/library/ruby:4.0.6-slim@sha256:58479f164d5947f852da27a4436c89bb986a811f959c40552bc7f6ccaabcc9c9 AS base
...
RUN set -eux ; \
    ...
    apt-get install --no-install-recommends -y curl libjemalloc2 shared-mime-info sqlite3 ; \
...
RUN set -eux ; \
    ...
    gem install bundler --version "4.0.19" --force
