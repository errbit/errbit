...
FROM registry.docker.com/library/ruby:3.4.3-slim@sha256:bf1ae63808063b7c3ba614d7e2e290011812ebffb7fd773f5ac4081d0c88538a AS base
...
RUN set -eux ; \
    ...
    gem install bundler --version "2.6.8" --force
