...
FROM registry.docker.com/library/ruby:4.0.1-slim@sha256:35c40b68acea3afc603f1513a2cbc732ec8e0e7d457241485ec10044b96254ac AS base
...
RUN set -eux ; \
    ...
    gem install bundler --version "4.0.5" --force
