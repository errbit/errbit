...
FROM registry.docker.com/library/ruby:4.0.1-slim@sha256:f3207b8383a8ed08a043e960984b756a957f05217f1724f9001712696bfaea88 AS base
...
RUN set -eux ; \
    ...
    gem install bundler --version "4.0.7" --force
