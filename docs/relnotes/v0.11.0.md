...
2. Upgrade to Ruby 4.0.5
3. Upgrade to RubyGems 4.0.13
4. Upgrade to Bundler 4.0.13
5. Upgrade to Rails 8.1.3
...
7. Start integrating the `pundit` gem. From now on, only admin users can see all users.
8. Add Brakeman GitHub Action.
9. Add `.editorconfig`
10. Integrate Trivy for container image scanning.
11. The deprecated `sucker_punch` gem was removed. Active Job now uses the `async` queue adapter instead.
