...
puts "-- username: #{admin_username}" if Rails.configuration.errbit.user_has_username
...
user.username = admin_username if Rails.configuration.errbit.user_has_username
user.admin = true
user.save!
