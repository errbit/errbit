...
ActiveRecord::Schema.define(version: 20151003182011) do
  ...
  add_index "comments", ["err_id"], name: "index_comments_on_err_id", using: :btree
  ...
  add_index "problems", ["app_name"], name: "index_problems_on_app_name", using: :btree
  ...
  add_index "watchers", ["app_id"], name: "index_watchers_on_app_id", using: :btree
