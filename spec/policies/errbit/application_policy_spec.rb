...
RSpec.describe Errbit::ApplicationPolicy do
  ...
  describe "#permitted_attributes" do
    ...
    it {
      expect { subject.permitted_attributes }
        .to raise_error(NotImplementedError, "You must define #permitted_attributes in Errbit::ApplicationPolicy")
    }
  end
end
  ...
  describe "#resolve" do
    ...
    it {
      expect { subject.resolve }
        .to raise_error(NotImplementedError, "You must define #resolve in Errbit::ApplicationPolicy::Scope")
    }
  end
end
