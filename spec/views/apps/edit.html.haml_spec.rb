describe "apps/edit.html.haml", type: 'view' do
  ...
  describe "content_for :action_bar" do
    ...
    it "should confirm the 'reset' link" do
      render
      expect(action_bar).to have_selector('a.btn[data-confirm="%s"]' % I18n.t('apps.confirm_destroy_all_problems'))
    end

    it "should confirm the 'destroy' link" do
      render
      expect(action_bar).to have_selector('a.btn[data-confirm="%s"]' % I18n.t('apps.confirm_delete'))
    end
  end
