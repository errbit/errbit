describe "problems/show.html.haml", type: 'view' do
  ...
  describe "content_for :action_bar" do
    ...
    it "should confirm the 'resolve' link by default" do
      render
      expect(action_bar).to have_selector('a.btn[data-confirm="%s"]' % I18n.t('problems.confirm.resolve_one'))
    end
    ...
    it "should not confirm the 'resolve' link if configured not to" do
      ...
      render
      expect(action_bar).to have_selector('a.btn[data-confirm="null"]')
    end
    ...
    it "should link 'up' to HTTP_REFERER if is set" do
      ...
      render
      expect(action_bar).to have_selector("a.btn[href='#{url}']", :text => 'up')
    end
    ...
    it "should link 'up' to app_problems_path if HTTP_REFERER isn't set'" do
      ...
      expect(action_bar).to have_selector("a.btn[href='#{app_problems_path(problem.app)}']", :text => 'up')
    end
