  ...
  describe "#gravatar_tag" do
    ...
    context "default config" do
      ...
      it "should render image_tag with correct alt and src" do
        expected = "<img alt=\"#{email}\" class=\"gravatar\" width=\"48\" height=\"48\" src=\"#{base_url}?d=identicon&amp;s=96\" />"
        expect(helper.gravatar_tag(email, s: 48)).to eq(expected)
      end

      it "should override :d" do
        expected = "<img alt=\"#{email}\" class=\"gravatar\" width=\"48\" height=\"48\" src=\"#{base_url}?d=retro&amp;s=96\" />"
