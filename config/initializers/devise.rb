...
Devise.setup do |config|
  ...
  config.mailer_sender = Config.main.email_from
  ...
  config.authentication_keys = [Config.main.user_has_username? ? :username : :email]
  ...
  config.case_insensitive_keys = [Config.main.user_has_username? ? :username : :email]

  # Configure which authentication keys should have whitespace stripped.
  # These keys will have whitespace before and after removed upon creating or
  # modifying a user and when used to authenticate or find a user. Default is :email.
  config.strip_whitespace_keys = [Config.main.user_has_username? ? :username : :email]
