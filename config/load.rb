...
Errbit::Config = Configurator.run(
  ...
  # database
  database_authentication:     ['DATABASE_AUTHENTICATION', lambda do |values|
    values[:database_authentication].nil? || values[:database_authentication] # Default will be true
  end],
  # github
