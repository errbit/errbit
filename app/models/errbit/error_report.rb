...
module Errbit
  ...
  class ErrorReport
    ...
    def rails_env
      env = server_environment["environment-name"]
      env.presence || "development"
    end
    ...
    # Launch all notifications defined on the app associated with this notice.
    ...
    ##
    # Err associated with this error_report. Created if it doesn't exist.
    #
    # @return [ Errbit::Err ]
    def error
