...
module Errbit
  class Mailer < ApplicationMailer
    ...
    def err_notification
      ...
      @notice = Errbit::NoticeDecorator.new(error_report.notice)
      @app = Errbit::AppDecorator.new(error_report.app)
      ...
      errbit_headers "App" => @app.name,
        ...
        "Error-Id" => error_report.notice.err.id
    ...
    def comment_notification
      ...
      @comment = comment
      @user = comment.user
      @problem = Errbit::ProblemDecorator.new(comment.err)
      @notice = Errbit::NoticeDecorator.new(comment.err.notices.first)
      @app = @problem.app
